    ...
    return (
        <>
            <section className='text-foreground-white w-full h-full flex flex-col item-center justify-center'>
                <header className='h-1/3 flex flex-col item-center justify-end pb-7'>
                    <div className='flex justify-center'>
                        <PiHandshakeThin className='size-12' />
                    </div>
                    <h1 className='text-center font-title text-2xl font-extrabold'>Welcome Back to Peak Mode</h1>
                    <p className='text-center font-heading text-md opacity-95'>Log in to access your personalized dashboard and continue your journey with tracked sets, sessions, and insights—all ready and waiting.</p>
                </header>
                <hr className='w-full opacity-20 border border-foreground-white mx-auto mb-3' />
                <form action=""
                    ...
                    <div className='flex items-center justify-between w-full mb-3'>
                        <div className='flex gap-1 items-center'>
                            ...
                            <label className='font-title text-md' htmlFor="remember-me">Remember Me</label>
                        </div>
                        <button type="button" className='font-title duration-150'>
                            <span>Forgot Your Password?</span>
                        </button> 
                    </div>
                    <button type="submit" className='mb-5 px-2 flex items-center justify-center gap-1 rounded-md h-10 w-1/2 md:w-3/4 bg-background-tertiary font-title hover:bg-primary-purple duration-150'>
                        <span>Log in</span>
                    </button>  
        ...
        <>
            ...
            {accountFormIsVisible && 
                <div className='fixed top-0 left-0 w-screen h-screen z-40 flex items-center justify-center'>
                    <div id="account-container" className='z-42 flex items-center justify-center p-4 w-full h-3/4'>
                        <div id='infos-container'
                            className='flex flex-col justify-between p-6 bg-background-purple-lining w-full h-full rounded-4xl relative'>
