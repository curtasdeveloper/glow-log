...
function FeatureCard({index ,icon, heading, text}) {
    ...
    function showPreview() {
        ...
        // FIX the rendering animation like fade in and out or some delay before showing
        // if (isVisible) {
        //     console.log(`Preview for ${heading} is showing.`);
        // } else {
        //     console.log(`Preview for ${heading} is now not showing.`);
        // }
