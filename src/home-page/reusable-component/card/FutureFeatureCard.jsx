...
function FeatureCard({icon, heading, text}) {
    return (
        <section className='flex flex-col gap-2 items-center text-foreground-white bg-background-secondary p-2 rounded-2xl hover:translate-y-[-4px] duration-150 w-3/4 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5'>
            {icon}
