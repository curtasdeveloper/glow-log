...
function HomeMainContent() {    
    return (
        <>
            <main className='flex flex-col items-center justify-center h-[80vh] pt-[20vh] ' id='home-section'>
                ...
                <button onClick={console.log("Profile form should be visible...")} className='h-[48px] w-[148px] bg-zinc-900 text-zinc-100 rounded-[4px] inconsolata'>get started.</button>
            </main>
