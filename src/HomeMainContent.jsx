    ...
    return (
        <>
            <main className='flex flex-col items-center justify-center h-[60vh]'>
                ...
                <p className="mb-[32px] text-8xl cormorant-garamond text-zinc-900 font-semibold">HEALTH</p>
                <button className='h-[48px] w-[128px] bg-zinc-900 text-zinc-100 rounded-[4px] inconsolata'>get started.</button>
            </main>
            <footer className='h-[20vh] flex items-center justify-center'>
                <p className='text-2xl font-light inconsolata'>Your journey to a healthier body, smarter spending, and a brighter future—fully logged.</p>
            </footer>
        </>    
    )
}    
