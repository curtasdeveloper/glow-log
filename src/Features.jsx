...
function FeaturesContent({title, description}) {
    return (
        <section className='max-w-[400px] mx-auto flex items-center flex-col gap-2 hover:scale-105 transition duration-300'>
...
function Features() {
    ...
    return (
        <>
            <header className="h-[20vh]" id='features-section'></header>
